...
class TkFileDialogExample(Tkinter.Frame):
    def __init__(self, root):
        ...
        Tkinter.Entry(root, textvariable=self.sp, width=100).pack()
        Tkinter.Label(root, text="Make CARMs").pack()
        Tkinter.Checkbutton(root, variable=self.repl).pack()
        Tkinter.Label(root, text="Do not use ENOVIA references").pack()
...
def IRMer_nonc():
        ...
        for det in xrange(1, products_inwork.Count+1):
            ...
            if 'FAIRING' in str(product_inwork_nonc.PartNumber):
                if not state:
                    ...
                    Instantiate_carm_upper_final(product_inwork_nonc, name, product_forpaste_upr)
                product_inwork_nonc = products_inwork.Item(det)
                irm_type = 'OMF'
                Instantiate_fairing(product_inwork_nonc, name)
                state = True
            else:
                ...
                if state:
                    ...
                    product_forpaste_upr = products1.Item('ECS_' + irm_type + '_AIR_DIST_INSL_' + str(dash_number - 1))
  ...
  # LOWERS NON-CONSTANT:
                ...
                if state:
                    add_new_irm(irm_type)
                    product_forpaste_lwr = products1.Item('ECS_' + irm_type + '_AIR_DIST_INSL_' + str(dash_number - 1))
                ...
                if state:
                    Instantiate_carm_upper_nonc(product_inwork_nonc, name, product_forpaste_upr)
                elif not state:
                    Instantiate_carm_upper_middle_nonc(product_inwork_nonc, name, product_forpaste_upr)
                    #doesn't work:
                    if products_inwork.Count:
                        print 'FOUND IT'
                        Instantiate_carm_upper_final_nonc(product_inwork_nonc, name, product_forpaste_upr)
                state = False
...
#UPPERS:
        ...
        if 'FAIRING' in str(product_inwork.PartNumber):
            if not state:
                ...
                Instantiate_carm_upper_final(product_inwork, name, product_forpaste_upr, first_elem_in_irm)
                first_elem_in_irm[:] = []
            product_inwork = products1.Item(prod)
            irm_type = 'OMF'
            Instantiate_fairing(product_inwork, name)
            state = True
...
#LOWERS:
            ...
            order_of_templete_product += 1
            if state:
                Instantiate_carm_upper(product_inwork, name, product_forpaste_upr)
            elif not state:
                Instantiate_carm_upper_middle(product_inwork, name, product_forpaste_upr)
...
def Instantiate_fairing(product_inwork_nonc, name):
    global order_of_templete_product
    global order_of_new_product
    global dash_number
    productDocument1 = CATIA.ActiveDocument
    ...
    if make_carms == True:
        ...
        carm_instance = CARM(carm_pn, carm_name, side, order_of_new_product, order_of_templete_product, name)
...
def Instantiate_carm_upper(product_inwork_nonc, name, product_forpaste_upr):
    ...
    if make_carms == True:
        # INITIAL
        carm_instance = CARM_UPR(carm_pn, carm_name, side, (order_of_new_product-1), order_of_templete_product, name)
        wb = carm_instance.workbench_id()
        if wb != 'Assembly':
            carm_instance.activate_top_prod()
        carm_instance.add_carm_as_external_component()
...
def Instantiate_carm_upper_middle(product_inwork_nonc, name, product_forpaste_upr):
        # FOR ALL
    copy_from_name = product_inwork_nonc.Name
    print copy_from_name
    products_inwork_nonc = product_inwork_nonc.Products
...
def Instantiate_carm_upper_final(product_inwork_nonc, name, product_forpaste_upr, first_elem_in_irm):
    ...
    if make_carms == True:
        ...
        carm_instance = CARM_UPR(carm_pn, carm_name, side, (order_of_new_product-1), order_of_templete_product, name, first_elem_in_irm)
        wb = carm_instance.workbench_id()
        if wb != 'Assembly':
            carm_instance.activate_top_prod()
        carm_instance.set_standard_parts_params(1)
...
def Instantiate_carm_upper_nonc(product_inwork_nonc, name, product_forpaste_upr):
    ...
    if make_carms == True:
        # INITIAL
        carm_instance = CARM_UPR_NONC(carm_pn, carm_name, side, (order_of_new_product-1), order_of_templete_product, name)
        wb = carm_instance.workbench_id()
        if wb != 'Assembly':
            carm_instance.activate_top_prod()
        carm_instance.add_carm_as_external_component()
...
def Instantiate_carm_upper_middle_nonc(product_inwork_nonc, name, product_forpaste_upr):
...
def Instantiate_carm_upper_final_nonc(product_inwork_nonc, name, product_forpaste_upr):
...
def Instantiate_carm_lwr(product_inwork_nonc, name, product_forpaste_upr, state):
    ...
    if make_carms == True:
        # INITIAL
        carm_instance = CARM_LWR(carm_pn, carm_name, side, order_of_new_product, order_of_templete_product, name)
        wb = carm_instance.workbench_id()
        if wb != 'Assembly':
            carm_instance.activate_top_prod()
        if state == 'initial':
        ...
        carm_instance.copy_bodies_and_paste('BACS12FA3K3.1')
        ...
        carm_instance.copy_bodies_and_paste('BACS12FA3K3.2')
        carm_instance.copy_bodies_and_paste('BACS12FA3K3.3')
        ...
        if state == 'final':
            ...
            carm_instance.add_jd_annotation('03', sta_value_pairs, size, side)
            carm_instance.access_captures(9)
            carm_instance.add_jd_annotation('04', sta_value_pairs, size, side)
            carm_instance.access_captures(1)
            carm_instance.hide_unhide_captures('unhide', 1)
            carm_instance.activate_top_prod()
    ...
    for number in s:
        ...
        if str(number) == 'door':
            ...
            if section == 'constant':
                ...
                PlenumAssy = RenamingTool.Products.Item(1)
                LING_VAL = RenamingTool.Products.Item(2)
                sta_values_fake.append(STAvalue(
                    (fake_coord_nonconstant_41 + x_coord_nonconstant - Inch_to_mm(int(number))),
                    plug_value))
                ...
                sta_values_fake.append(STAvalue(
                    (fake_coord_nonconstant_47 + x_coord_nonconstant - Inch_to_mm(int(number))),
                    plug_value))
                sta_value_pairs.append(x_coord_nonconstant)
                print sta_value_pairs
                print sta_values_fake
